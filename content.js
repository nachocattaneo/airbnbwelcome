...
const siteContent = {
  restaurants: [
    ...
    },
    {
      ...
      details: {
        es: 'Pizzería napolitana de masa fina y bordes aireados, ideal para una cena informal. Probá sus pizzas recién salidas del horno. · Aprox. 3 min caminando',
        en: 'Neapolitan pizzeria with thin dough and airy crusts, ideal for a relaxed dinner. Try its pizzas straight from the oven. · Approx. 3 min walk'
      },
    ...
    },
    {
      ...
      details: {
        es: 'Izakaya japonés íntimo, con yakitori, sushi y vinilos. La parrilla y sus brochettes son el corazón de la propuesta. · Aprox. 10 min caminando',
        en: 'An intimate Japanese izakaya with yakitori, sushi and vinyl records. The grill and its skewers are the heart of the menu. · Approx. 10 min walk'
      },
    ...
    },
    {
      ...
      details: {
        es: 'Café y pastelería 100% libre de gluten. Una gran opción para desayunar, merendar o disfrutar algo rico sin TACC. · Aprox. 2 min caminando',
        en: 'A 100% gluten-free coffee shop and bakery. A great choice for breakfast, an afternoon treat or gluten-free bites. · Approx. 2 min walk'
      },
    ...
    },
    {
      ...
      details: {
        es: 'Café y cocina keto con grandes ventanales, ideal para desayunar o merendar sin culpa. · Aprox. 2 min caminando',
        en: 'A keto café with big windows, ideal for a guilt-free breakfast or afternoon snack. · Approx. 2 min walk'
      },
    ...
    },
    {
      ...
      details: {
        es: 'Trattoria de esquina en Palermo, con pizzas, pastas caseras y ambiente relajado. · Aprox. 2 min caminando',
        en: 'A corner trattoria in Palermo, with pizzas, homemade pasta and a relaxed vibe. · Approx. 2 min walk'
      },
    ...
    },
    {
      ...
      details: {
        es: 'Cocina vietnamita con banh mi, pad thai y platos bien especiados. · Aprox. 5 min caminando',
        en: 'Vietnamese cuisine with banh mi, pad thai and well-spiced dishes. · Approx. 5 min walk'
      },
    ...
    },
    {
      ...
      details: {
        es: 'Bar íntimo de cócteles y tapas con tocadiscos de fondo, ideal para una cita. · Aprox. 8 min caminando',
